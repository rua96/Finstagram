      ...
      <div className="start">
        ...
        >
          <img
            class
            name="imma"
            src={props.menu === "Show" ? HomeActive : HomeInactive}
            alt={"Home"}
          />
        </button>
        ...
        >
          <img
            src={props.menu === "Create" ? PlusActive : PlusInactive}
            alt={"Home"}
          />
        </button>
        ...
        >
          <img
            src={props?.menu === "Show" ? UserBlack : UserWhite}
            alt="Profile"
          />
        </button>

        <button className="buttonLogout" type="button" onClick={onLogout}>
          <img class name="imma" src={LogoutIcon} alt="Logout" />
        </button>
      </div>
    </div>
  );
